...
parser.add_argument("--steps",          type=int, default=2000, help='-')
parser.add_argument("--batch-size",     type=int, default=128,    help='-')
parser.add_argument("--architecture",   type=str, default="935",  help='-')
parser.add_argument("--save-every",     type=int, default=1000,   help='-')
parser.add_argument("--save-best-only", type=int, default=1,      help='-')
...
if architecture not in ["935", "9335", "93335"]:
    raise ValueError("architecture must be 935, 9335 or 93335")
